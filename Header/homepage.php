  ...
  <div class = search_box_divider1>
    <div class = search_box_divider2>
      <div class = "label">
          ...
          <input class = "sell1" name = "brand" required = "required">
...
<?php
 if (isset($_POST['submitBtn'])) {
	include("conn.php");
      ...
      $insert="INSERT INTO sell_appointment (brand, model, year, variant, engine, transmission, mileage, price, date, time) 
      VALUES ('$_POST[brand]', '$_POST[model]','$_POST[year]', '$_POST[variant]', '$_POST[engine]','$_POST[transmission]','$_POST[mileage]', '$_POST[price]', '$_POST[booking_date]', '$_POST[booking_time]')";
