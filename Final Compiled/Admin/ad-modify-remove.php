...
<body>
        ...
        <table class="car-table">
            ...
            <?php 
                ...
                while($car = mysqli_fetch_array($item_result)){
                    ...
                    echo '<td>
                            <button class="editbtn"><a href="ad-car-edit.php?carID='.$car['carID'].'"><img src="imgAdmin/edit.png"></a></button>
                            <button class="deletebtn" name="delete-img" onclick="deleteCar('.$car['carID'].')"><img src="imgAdmin/bin.png"></a></button>
                          </td>';
                    echo "</tr>";
                }
            ?>
    ...
    <script> 
        function deleteCar(carID){
            if (confirm("Are you sure want to permenently delete the car record?\n *All other record that consist this carID will be deleted")){
                window.location.href="car-remove.php?carID="+carID;
            }
        }
    </script> 
