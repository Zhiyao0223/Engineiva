        ...
        <table class="car-table">
            ...
            <?php 
                ...
                while($cust = mysqli_fetch_array($item_result)){
                    ...
                    echo '<td>
                            <button class="editbtn"><a href="ad-cust-edit.php?custID='.$cust['custID'].'"><img src="edit.png"></a></button>
                            <button class="deletebtn" name="delete-img" onclick="deleteCust('.$cust['custID'].')"><img src="bin.png"></a></button>
                          </td>';
                    echo "</tr>";
                }
            ?>
